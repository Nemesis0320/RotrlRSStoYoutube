...
ffmpeg -y -i assets/1200x1200bf.png -i assets/test_audio.mp3 -filter_complex_script assets/circular_waveform.ffgraph -map "[outv]" -map 1:a -c:v libx264 -preset veryfast -crf 18 -c:a aac -b:a 192k output_test.mp4
