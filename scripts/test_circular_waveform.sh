...
[1:a]showwaves=s=1200x1200:mode=p2p:colors=white:scale=lin*12[wave_raw]; \
[wave_raw]format=rgba,colorchannelmixer=rr=1:rg=0.4:rb=0:gr=1:gg=0.4:gb=0:br=0.2:bg=0:bb=0[wave_color]; \
[wave_color]eq=brightness=0.35:contrast=2.2:saturation=1.4[wave_bright]; \
[wave_bright]gblur=sigma=10[wave_glow]; \
